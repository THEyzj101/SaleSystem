...
public class windowsToChangePassword extends JFrame{
	...
	public windowsToChangePassword() {
		...
		JLabel Label_forgetPassword_newPassword = new JLabel("New label");
